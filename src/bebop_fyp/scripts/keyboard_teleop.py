...
class keyTelop():
    ...
    def __init__(self, interface):
        ...
        self._pitch_rate = rospy.get_param('~PilotingSettingsMaxTiltCurrent', 0.8)
        self._roll_rate = rospy.get_param('~PilotingSettingsMaxTiltCurrent', 0.8)
        self._yaw_rate = rospy.get_param('~SpeedSettingsMaxRotationSpeedCurrent', 0.8)
        self._vertical_rate = rospy.get_param('~SpeedSettingsMaxVerticalSpeedCurrent', 0.8)
